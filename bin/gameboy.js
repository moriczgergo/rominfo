...
// Defining contstants
const nintendoLogoHash = "9f107f8cf6007e6a394eef120288ba33";
...
function recognize(data) {
	...
	var logo = data.subarray(0x0104, 0x0134);
	var hash = md5(logo);
	if (hash == nintendoLogoHash) {
		return true;
	}
	return false;
}
...
function newLicenseeCode(data) {
	var raw = data.subarray(0x0144, 0x0146);
	var newLicenseeCode = new Buffer(raw).toString('ascii');
